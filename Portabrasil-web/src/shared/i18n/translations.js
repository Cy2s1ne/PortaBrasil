export const TRANSLATIONS = {
  zh: {
    appName: '巴西海关报关系统',
    nav_home: '首页', nav_upload: '文档上传', nav_process: '流程跟踪', nav_cost: '成本分析', nav_report: '报表分析', nav_admin: '用户管理',
  ...
  en: {
    ...
    nav_home: 'Home', nav_upload: 'Doc Upload', nav_process: 'Process Tracking', nav_cost: 'Cost Analysis', nav_report: 'Reports', nav_admin: 'User Management',
  ...
  pt: {
    ...
    nav_home: 'Início', nav_upload: 'Upload de Docs', nav_process: 'Rastreamento', nav_cost: 'Análise de Custos', nav_report: 'Relatórios', nav_admin: 'Gestão de Usuários',
