export const TRANSLATIONS = {
  zh: {
    ...
    admin_manage_admin_blocked: '普通管理员不能管理管理员账号',
  ...
  en: {
    ...
    admin_manage_admin_blocked: 'Regular admins cannot manage administrator accounts',
  ...
  pt: {
    ...
    admin_manage_admin_blocked: 'Administradores comuns não podem gerenciar contas de administrador',
